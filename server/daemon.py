...
class Daemon(LoggedClass):
        ...
        async with self.workqueue_semaphore:
            async with self.client_session() as session:
                ...
                async with session.post(self.url(), data=data) as resp:
                    ...
                    #self.logger.info('wdy to {}'.format(self.logged_url()))
    ...
    async def getallwitnesses(self):
        '''Return all the withesses in blockchain.'''
        return await self._send_single('listdelegates')
        
    async def listvoteddelegates(self, address):
        '''Return vote info of the address.'''
        return await self._send_single('listvoteddelegates', address)
